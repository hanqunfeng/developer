...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        // 设置不拦截规则
        web.ignoring().antMatchers("/admin*/**","/actuator*/**","/logger**","/rabbitmq/**","/checkcode/**","/resource/**","/**/*.jsp", "/access/sameLogin.do", "/**/*.json*", "/**/*.xml*", "/druid/**","/forgotPassword.do","/forgotPasswordEmail.do","/resetPassword.do");
